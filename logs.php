...
#lblIme{
  color:red;
   ...
   <body>
    ...
    <br>
    <br>
      <h1 align="center" style="font-family:verdana">LOGOVI</h1>
    <div class="container" >
...
<?php $sql = "SELECT * FROM logovi ORDER BY datum DESC  ";
  ...
  <div class ="col-md-12 col-md-offset-2" style="width:100%">
    <table id="tabela" class="table table-bordered table-hover" >
      <thead> <tr>
        ...
        <th class="not_mapped_style" style="text-align:center">Datum</th>
   ...
   <?php
      ...
      while($row = $result-> fetch_assoc()){?>
        <tr>
             ...
             <td align='center'><?php echo $row['tipKorisnika'] ?></td>
